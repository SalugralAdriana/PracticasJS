...
/*
          <div class="totals" id="cart_totals">
             <h6 class="totals-title">Total del carrito</h6>
             <div class="totals-subtotals">Subtotal: </div>
             <div class="totals-coupon">Descuento del cupón: </div>
             <div class="totals-totals">Total: </div>
          </div>*/
...
// funcion totales
function cartTotals() {console.log(couponApply)
   // var subtotals = 0; 
    var subtotals = 0
